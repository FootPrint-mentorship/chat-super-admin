...
const dispatch = useAppDispatch();
    const menuItems = [
        ...
        },
        {
            name: 'Beneficiaries',
            link: '/beneficiaries',
            active: router.pathname === '/beneficiaries',
        ...
        },
        {
            name: 'Vendors',
            link: '/vendors',
            active: router.pathname === '/vendors',
        ...
        },
        {
            name: 'Cash for Work',
            link: '/cash-for-work',
            active: router.pathname === '/cash-for-work',
        ...
        },
        {
            name: 'Platform Guide',
            link: '/platform-guide',
            active: router.pathname === '/platform-guide',
            icon: <svg className="w-4 h-4 " width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    return (
            ...
            <div className="absolute top-0 left-0 z-40 h-screen p-4 overflow-y-auto  bg-white w-80 flex flex-col gap-5" aria-labelledby="drawer-label">
                <div className={'flex items-center justify-between '}>
                   <Logo/>
                    <button onClick={onClick} type="button" data-drawer-hide="drawer-example" aria-controls="drawer-example"
                ...
                <ul className="flex flex-col gap-5 flex-grow mt-10">
                    {menuItems.map((item) => (
                        <li key={item.name}>
                            <Link href={item.link}>
                                <div
