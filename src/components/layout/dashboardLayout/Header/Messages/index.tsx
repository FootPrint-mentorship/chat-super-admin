        ...
        <div className={'relative'}>
            ...
            <svg className="w-6 h-6 text-primaryTextColor" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd"
                      ...
                      fill="#707FA3"/>
                <path fillRule="evenodd" clipRule="evenodd"
                      d="M5.75 10.3574C5.75 9.94321 6.08579 9.60742 6.5 9.60742H15.5C15.9142 9.60742 16.25 9.94321 16.25 10.3574C16.25 10.7716 15.9142 11.1074 15.5 11.1074H6.5C6.08579 11.1074 5.75 10.7716 5.75 10.3574Z"
                      fill="#707FA3"/>
                <path fillRule="evenodd" clipRule="evenodd"
                      d="M5.75 7C5.75 6.58579 6.08579 6.25 6.5 6.25H11C11.4142 6.25 11.75 6.58579 11.75 7C11.75 7.41421 11.4142 7.75 11 7.75H6.5C6.08579 7.75 5.75 7.41421 5.75 7Z"
                      fill="#707FA3"/>
            </svg>
