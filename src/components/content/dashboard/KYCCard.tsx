...
function KycCard() {
    return (
        <>
            <div className={'hidden border-2 border-[#F2994A] border-solid p-6 mt-8 sm:flex items-center justify-between rounded-lg'}>
                <div className={'flex items-center gap-2'}>
                    <Image src={'/assets/svg/kyc.svg'} alt={'kyc'} width={60} height={60}/>
                    <div>
                        <h4 className={'text-[#07080A] font-bold'}>Verify your Account </h4>
                        <p className={'text-[#646A86] text-sm '}>To access all CHATS service, please complete your KYC
                            verification process</p>
                    </div>
                </div>

                <p className={'underline text-[#17CE89] text-xs'}>
                    Get Verified
                </p>
            </div>

            <div className={'sm:hidden border-none bg-[#FFFDED] p-6 flex flex-col gap-5 '}>
                <div className={'flex items-center gap-2'}>
