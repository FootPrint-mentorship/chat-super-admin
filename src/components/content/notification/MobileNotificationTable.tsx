...
interface MobileNotificationTableProps {
    filteredNotifications: Notification[];
}

function MobileNotificationTable({filteredNotifications}: MobileNotificationTableProps) {
    return (
        <div className="block lg:hidden">
            {filteredNotifications.map((notification, index) => (
                <div
                    key={index}
                    className="bg-white shadow-lg mb-4 p-4 rounded-lg border border-gray-200"
                >
