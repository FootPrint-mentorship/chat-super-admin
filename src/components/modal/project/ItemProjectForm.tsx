...
const ItemProjectFormModal = ({ isOpen, onClose }: ItemProjectFormProps) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center px-4 md:px-0 bg-black bg-opacity-80 z-50">
            ...
            <div className="bg-white py-2 pb-4 rounded-lg shadow-md w-full max-w-lg">
                ...
                <h2 className="text-xl font-semibold mb-6 text-center">New Item Project </h2>
                <form className="flex flex-col gap-2 px-6 h-[600px]  overflow-x-hidden">
                    ...
                    <div>
                        <label className="block text-sm font-medium">Total Items to be distributed</label>
                        <Input
                            type={'number'} placeholder={'0.00'}
...
export default ItemProjectFormModal;
