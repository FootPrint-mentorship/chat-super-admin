...
function PreviewBeneficiaries({onClose,project_name, open}: ArchiveProjectsModalProps) {
    if(!open) return null;
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center px-4 md:px-0 bg-black bg-opacity-80 z-50">
            ...
            <div className="bg-white py-2 pb-4 rounded-lg shadow-md w-full max-w-lg">
                ...
                <h2 className="text-2xl font-semibold mb-6 text-center">Beneficiary Preview</h2>
...
export default PreviewBeneficiaries;