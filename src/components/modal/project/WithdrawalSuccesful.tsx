...
function WithdrawalSuccessful({isOpen, onClose}:{isOpen: string | undefined | boolean, onClose: () => void}) {
    if(!isOpen){
        return
    }
    return (
        <div className="fixed inset-0 flex items-center justify-center px-4 md:px-0 bg-black bg-opacity-80 z-50">
            <div className="bg-white py-2 pb-4 rounded-lg shadow-md w-full max-w-lg">
                ...
                <h2 className="text-xl font-semibold mb-6 text-center">Withdrawal successful</h2>

                <div className="flex justify-center px-8">
                    <p className={'text-center text-primaryTextColor font-medium'}>Unspent funds have been added back to <br/> your wallet balance.</p>
