...
function DeleteCampaignModal({onClose,project_name}: DeleteCampaignModalProps) {
    return (
        <div className="fixed inset-0 flex items-center justify-center px-4 md:px-0 bg-black bg-opacity-80 z-50">
            ...
            <div className="bg-white py-2 pb-4 rounded-lg shadow-md w-full max-w-lg">
                ...
                <h2 className="text-2xl font-semibold mb-6 text-center">Delete Campaign</h2>

                <div className="flex justify-center px-8">
                    <p className={'text-center text-primaryTextColor font-medium'}> You are about to delete {project_name}.<br/> Are you really sure about this? This action <br/> cannot be undone.</p>
                ...
                <div className="flex justify-center gap-4 flex-col md:flex-row mt-8 px-8">
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="px-4 py-2 w-full text-secondaryBgColor bg-['inherit'] border-borderColor border-2 rounded-md font-bold"
                    >
                        Cancel
                    </button>
                </div>
