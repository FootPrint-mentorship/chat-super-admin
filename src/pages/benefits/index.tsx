        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md">
            <div className="px-4 flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Project Beneficiaries</h2>
              <div>
            ...
            <table className="w-full text-left text-[16px] font-medium border-collapse text-[#25396F]">
              <thead className="h-[59px]">
                <tr className="bg-[#F7F7F7]">
                  ...
                  <th className="px-4 py-2 font-bold text-xs">Origination</th>
              ...
              <tbody>
                {projects.map((project, index) => (
                  <tr key={project.id} className="border-gray-200">
                    ...
                    {/* <td className="px-8 py-6 text-xs">{project.verification}</td> */}
                    <span
