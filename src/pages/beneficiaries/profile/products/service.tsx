...
const cashData = [
  { id: "1", product: "Rice", tag: "Product", unitCost: "1,000.00", quantity: "12", amount: "12,000.00" },
  { id: "2", product: "Beans", tag: "Service", unitCost: "2,000.00", quantity: "12", amount: "13,000.00" },
  { id: "3", product: "Yam", tag: "Product", unitCost: "3,000.00", quantity: "12", amount: "14,000.00" },
  { id: "4", product: "Garri", tag: "Service", unitCost: "5,000.00", quantity: "12", amount: "15,000.00" }
];

const itemsData = [
  { id: "1", product: "Milk", tag: "Product", unitCost: "800.00", quantity: "5", amount: "4,000.00" },
  { id: "2", product: "Bread", tag: "Product", unitCost: "500.00", quantity: "8", amount: "4,000.00" },
  { id: "3", product: "Butter", tag: "Product", unitCost: "2,000.00", quantity: "3", amount: "6,000.00" },
  { id: "4", product: "Cleaning Service", tag: "Service", unitCost: "4,000.00", quantity: "2", amount: "8,000.00" }
];
  ...
  return (
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="px-4 flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Products/Services(32)</h2>
              <div>
        ...
        <div className="p-4">
          ...
          <table className="w-full text-left text-[16px] font-medium border-collapse text-[#25396F]">
            <thead className="h-[59px] bg-[#F7F7F7]">
              <tr>
                <th className="px-4 py-2 font-bold text-xs">Product/Service</th>
                <th className="px-4 py-2 font-bold text-xs">Tag</th>
                <th className="px-4 py-2 font-bold text-xs text-right">Unit Cost (NGN)</th>
                <th className="px-4 py-2 font-bold text-xs text-right">Quantity Redeemed</th>
                <th className="px-4 py-2 font-bold text-xs text-right">Amount (NGN)</th>
              </tr>
            </thead>
            <tbody>
                ...
                <tr key={item.id} className="border-gray-200">
                  ...
                  <td className="px-4 py-4 text-xs">
                    <span className={`px-2 py-1 rounded-full text-xs ${
                      item.tag === "Product" ? "bg-blue-100 text-blue-600" : "bg-green-100 text-green-600"
                    }`}>
                      {item.tag}
                    </span>
                  </td>
                  <td className="px-4 py-4 text-xs text-right">{item.unitCost}</td>
                  <td className="px-4 py-4 text-xs text-right">{item.quantity}</td>
                  <td className="px-4 py-4 text-xs text-right">{item.amount}</td>
                </tr>
              ))}
            </tbody>
          </table>
