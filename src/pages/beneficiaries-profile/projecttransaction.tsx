...
const cashData = [
  {
    beneficiary: "Declan Rice",
    vendor: "Theresa Webb",
    amount: "NGN 25,000",
    status: "Processed",
    date: "Dec 3, 2024|12.45pm",
    ...
    <DashboardLayout title="Beneficiary - Profile" header="NGO">
      <div className="flex flex-col gap-8">
        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="px-4 flex items-center gap-4 border-b ">
  {tabItems.map((tab) => (
    <button
      key={tab.value}
            ...
            <table className="w-full text-left text-[16px] font-medium border-collapse text-[#25396F]">
              <thead className="h-[59px] bg-[#F7F7F7]">
                <tr className="bg-[#F7F7F7]">
                  ...
                  <th className="px-4 py-2 font-bold text-xs">Vendor</th>
                  <th className="px-4 py-2 font-bold text-xs">Amount</th>
              ...
              <tbody>
                {displayedData.map((item) => (
                  <tr key={item.beneficiary} className="border-gray-200">
                    <td className="px-4 py-4 text-xs flex items-center gap-3">
                      <img
                        src={item.avatar}
                    ...
                    <td className="px-4 py-4 text-xs">{item.vendor}</td>
                    <td className="px-4 py-4 text-xs">{item.amount}</td>
                    <td className="px-4 py-4 text-xs">{item.status}</td>
                    <td className="px-4 py-4 text-xs">{item.date}</td>
                  </tr>
                ))}
              </tbody>
            </table>
